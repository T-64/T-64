...
- **Stuttgart** — M.Sc. INFOTECH student, University of Stuttgart (Beijing → Stuttgart)
- **Research** — 3D Gaussian Splatting for RGB-D SLAM
- **Internships** — Tencent (search-ads inference) · Huawei (cloud-network software)
- **Focus** — ML systems · data pipelines · reproducible research
- **Now** — learning German, A2 → B1
