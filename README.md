...
- gaussian talking-head — real-time 3DGS digital-human avatar · ~65 fps · RTF 0.96 → 0.3 *(public soon)*
...
- [deutsch-daily](https://github.com/T-64/deutsch-daily) — Tagesschau, auto-turned into daily German–Chinese lessons

## Skills

- **Languages** — Mandarin (native) · English (C1, IELTS 7.5) · German (A1 → A2)
- **Programming & Tools** — Python, C++, 3DGS, XGBoost, Flink, Kafka, PyTorch, SLAM, Docker, Git, Linux
- **AI & Agents** — multi-agent workflows, MCP, agent harnesses / tooling, self-hosted LLMs
